/**
 * Static reference data for the auth registration form.
 * Extracted to its own module so the main AuthPortal component
 * stays lightweight and parses faster.
 */
...
export const DEGREE_OPTIONS = ['B.E', 'B.Tech', 'B.Sc', 'M.Sc', 'MBA', 'M.E', 'M.Tech', 'PhD'];

        ...
        <div className="h-full flex flex-col bg-white dark:bg-dark-950 animate-fade-in overflow-y-auto custom-scrollbar">
            ...
            <div className="flex-1 px-8 pb-8">
                <div className="max-w-[1240px] mx-auto space-y-5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {QUICK_ACTIONS.map(action => (
                            <button
                                ...
                                className="relative overflow-hidden group flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-dark-900 border border-slate-200 dark:border-dark-800 hover:border-slate-300 dark:hover:border-dark-700 transition-all duration-300 hover:shadow-lg dark:hover:shadow-none"
                            >
                                <div className={`w-9 h-9 rounded-xl bg-gradient-to-tr ${action.color} flex items-center justify-center text-white shadow-lg ${action.shadow} dark:shadow-none flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                                    <action.icon size={18} />
                                </div>
                                <span className="text-[13px] font-bold text-slate-700 dark:text-dark-200 group-hover:text-slate-900 dark:group-hover:text-dark-50 transition-colors">{action.label}</span>
                                <ArrowUpRight size={13} className="ml-auto text-slate-300 dark:text-dark-600 group-hover:text-synapse-500 transition-colors" />
                            </button>
                        ))}
                    </div>
                    ...
                    {/* Trending on Campus */}
                    <div className="bg-white dark:bg-dark-900 border border-slate-200 dark:border-dark-800 rounded-3xl p-4">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                                <TrendingUp size={14} className="text-amber-500" />
                                <h3 className="text-[11px] font-black uppercase text-slate-800 dark:text-dark-50 tracking-wider">Trending on Campus</h3>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-6 text-center">
                            <p className="text-xs text-slate-400 dark:text-dark-500">No trending notes yet. Start sharing to see what's popular.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        ...
                        <div className="lg:col-span-3 bg-white dark:bg-dark-900 border border-slate-200 dark:border-dark-800 rounded-3xl overflow-hidden">
                            <div className="px-5 py-4 border-b border-slate-100 dark:border-dark-800 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="text-[11px] font-black uppercase text-slate-800 dark:text-dark-50 tracking-wider">Campus Activity</h3>
                                </div>
                            ...
                            <div className="divide-y divide-slate-100 dark:divide-dark-800">
                                {MOCK_ACTIVITY_FEED.map(item => (
                                    <div key={item.id} className="px-5 py-3 flex items-start gap-4 hover:bg-slate-50/50 dark:hover:bg-dark-800/30 transition-colors group cursor-pointer">
                                        <div className={`w-8 h-8 rounded-xl ${item.color} flex items-center justify-center flex-shrink-0 mt-0.5`}>
                                            {item.icon}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-[12px] font-semibold text-slate-700 dark:text-dark-200 leading-snug mb-1">{item.message}</p>
                                            <div className="flex items-center gap-3">
                                        ...
                                        <ArrowUpRight size={13} className="text-slate-300 dark:text-dark-600 opacity-0 group-hover:opacity-100 transition-opacity mt-1" />
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            {/* AI Engine Status */}
                            <div className="bg-gradient-to-br from-synapse-600 to-synapse-800 rounded-3xl p-4 text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h4 className="text-lg font-black mb-0.5">Ready</h4>
                                    <p className="text-xs font-medium opacity-80 mb-4">BGE embeddings active on CPU</p>
                                    <div className="flex items-center gap-3">

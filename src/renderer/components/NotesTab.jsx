    ...
    return (
        <div className="h-full flex flex-col" style={{ background: 'var(--surface-app)' }}>
            ...
            <div
                ...
                style={{ background: 'var(--surface-card)', borderBottom: '1px solid var(--border-subtle)', boxShadow: 'var(--shadow-sm)' }}
            >
                <div className="flex items-center justify-between mb-3">
                    <div>
                        <h2 className="text-[18px] font-bold tracking-tight" style={{ color: 'var(--text-hero)', letterSpacing: '-0.02em' }}>
                            Notes &amp; Deadlines
                        </h2>
                    ...
                    <button
                        ...
                        className="btn-primary flex items-center gap-1.5 text-[12.5px] py-1.5 px-3.5"
                    >
                    ...
                    {FILTERS.map((f) => {
                        ...
                        return (
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-2 text-[12px] font-medium rounded-t-lg border-b-2 transition-all duration-150 whitespace-nowrap flex-shrink-0"
                                style={
                                    active
                                        ? { borderBottomColor: 'var(--accent)', color: 'var(--accent)', background: 'var(--accent-light)' }
                                        : { borderBottomColor: 'transparent', color: 'var(--text-secondary)', background: 'transparent' }
                                }
                                onMouseEnter={(e) => { if (!active) { e.currentTarget.style.color = 'var(--text-primary)'; e.currentTarget.style.background = 'var(--surface-hover)'; } }}
                            ...
                            >
                                ...
                                {f.count > 0 && (
                                    <span
                                        className="text-[9.5px] font-bold px-1.5 py-[1px] rounded-full min-w-[16px] text-center"
                                        style={
                                            active
